...
export function opponentSystemPrompt(ctx: DebateContext): string {
  ...
  return [
    ...
    'Your reply MUST end with an emotion tag in this EXACT shape:',
    '    <emotion>X</emotion>',
    'where X is ONE word from this fixed set (case-insensitive):',
    '    confident · thoughtful · surprised · amused · firm',
    '',
    'Do NOT invent new tag names. Do NOT write <thoughtful></thoughtful>,',
    '<emotion type="x">, <mood>...</mood>, or any other variant. The literal',
    'word "emotion" MUST appear between the angle brackets.',
    '',
    '### Full example of a correct reply:',
    '```',
    'Firstly, the data clearly shows that ... For example, ...',
    'Secondly, ... Therefore, the proposition stands.',
    '',
    'POI: How do you reconcile your second argument with the 2023 OECD study?',
